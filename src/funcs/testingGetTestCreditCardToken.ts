...
import {
  ...
  GetTestCreditCardTokenResponse$zodSchema,
} from "../models/gettestcreditcardtokenop.js";
 ...
 */
export function testingGetTestCreditCardToken(
  client$: BoltCore,
...
> {
  const path$ = pathToFunc("/v1/testing/card_token")();
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetTestCreditCardTokenResponse$zodSchema, { key: "object" }),
