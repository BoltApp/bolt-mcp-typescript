...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateWebhookRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, CreateWebhookResponse$zodSchema, { key: "object" }),
    M.json([400, 403, 422], CreateWebhookResponse$zodSchema, {
