...
export type AddAddressSecurity = { OAuth: string; xAPIKey: string };

export const AddAddressSecurity$zodSchema: z.ZodType<
  AddAddressSecurity,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export const AddAddressRequest$zodSchema: z.ZodType<
  AddAddressRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
 ...
 */
export const AddAddressPriority$zodSchema = z.enum([
  "primary",
  "listed",
]).describe(
  "The shopper-indicated priority of this address compared to other addresses on their account.",
...
export type AddAddressPriority = z.infer<typeof AddAddressPriority$zodSchema>;
...
export type AddAddressResponseBody = {
  ...
  priority?: AddAddressPriority | null | undefined;
...
export const AddAddressResponseBody$zodSchema: z.ZodType<
...
> = z.object({
  ...
  priority: AddAddressPriority$zodSchema.nullable().optional(),
...
export const AddAddressResponse$zodSchema: z.ZodType<
  AddAddressResponse,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  object: z.lazy(() => AddAddressResponseBody$zodSchema).optional(),
});
